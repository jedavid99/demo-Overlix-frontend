...
export default function IPhoneInsurance() {
  ...
  const coverageTypes = [
    { value: 'screen', label: 'Solo Pantalla', description: 'Cubre solo rotura de pantalla' },
    { value: 'theft', label: 'Robo', description: 'Cubre robo del dispositivo' },
    { value: 'full', label: 'Completo', description: 'Cubre daños y robo' },
        ...
        <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center gap-2 mb-1">
                        <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                          ...
                          {formData.coverageType === type.value && <CheckCircle size={10} className="text-white" />}
                        </div>
          ...
          <Card>
            <CardContent className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <Label htmlFor="startDate" className="text-xs font-semibold">Fecha de Inicio *</Label>
                  <Input
                    id="startDate"
                    type="date"
                ...
                <div className="space-y-1">
                  <Label htmlFor="endDate" className="text-xs font-semibold">Fecha de Fin *</Label>
                  <Input
                    id="endDate"
                    type="date"
                ...
                <div className="space-y-1 md:col-span-2">
                  <Label htmlFor="coverageAmount" className="text-xs font-semibold">Monto de Cobertura Máxima ($) *</Label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground text-sm">$</span>
                    <Input
                      id="coverageAmount"
              ...
              <div className="bg-muted/50 rounded-lg p-3 space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-xs text-muted-foreground">Duración del seguro</span>
