...
import { Mail, Lock, Eye, EyeOff, LogIn, HelpCircle, Globe, Shield, ChevronRight, Building2, Facebook } from 'lucide-react'
        ...
        <div className="lg:w-1/2 h-full relative overflow-hidden hidden lg:block">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between p-12 text-white">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold">Ovelix</span>
            </div>
          ...
          <div className="min-h-full flex items-center justify-center p-8 lg:p-12">
            <div className="max-w-md w-full">
              <div className="lg:hidden flex items-center gap-2 mb-8">
                ...
                <span className="text-xl font-bold dark:text-white">Ovelix</span>
              </div>
              <div className="mb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-primary hover:bg-primary/90 text-white font-semibold rounded-xl shadow-lg shadow-primary/30 transition-all transform hover:scale-[1.02] flex items-center justify-center gap-2 group"
                >
