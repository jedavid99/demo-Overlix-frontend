    ...
    return (
      ...
      >
        <Card className="p-12 text-center">
          ...
          <h2 className="text-xl font-semibold mb-2">No hay datos financieros</h2>
          <p className="text-muted-foreground">No se encontraron transacciones para el período seleccionado.</p>
        </Card>
      </motion.div>
    )
  }
